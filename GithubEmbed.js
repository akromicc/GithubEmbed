class GithubEmbed {
  ...
  async getRepo() {
    const response = await fetch(`${this.baseUrl}/repos/${this.user}/${this.repo}`);
    if (!response.ok) {
  ...
  async getContributors() {
    const response = await fetch(`${this.baseUrl}/repos/${this.user}/${this.repo}/contributors?per_page=8`);
    if (!response.ok) {
    ...
    container.innerHTML = `
          <a href="#" target="_blank" style="text-decoration: none;">
              ...
              <div class="repo-stats">
                  <div class="repo-stat">
                      <svg xmlns="http://www.w3.user/2000/svg" width="20" height="20" viewBox="0 0 256 256">
                  ...
                  <div class="repo-stat">
                      <svg xmlns="http://www.w3.user/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                  ...
                  <div class="repo-stat">
                      <svg xmlns="http://www.w3.user/2000/svg" width="20" height="20" viewBox="0 0 16 16">
